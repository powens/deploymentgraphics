...
describe("presets match the YAML source", () => {
  ...
  // gwTerrain is generated by merging the hand-authored gw.yml (templates +
  // demo layout) with the generated 40kdc.yml (the ported layouts), mirroring
  // buildTerrain() in scripts/gen-presets.mjs.
  it("gwTerrain matches the merge of gw.yml and 40kdc.yml", () => {
    const gw = loadYaml("terrain/gw.yml") as {
      templates: Record<string, unknown>;
      layout: Record<string, unknown>;
    };
    const dc = loadYaml("terrain/40kdc.yml") as {
      templates?: Record<string, unknown>;
      layout: Record<string, unknown>;
    };
